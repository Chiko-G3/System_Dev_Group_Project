...
/* --- USER ACCESS (STAFF ACCOUNTS ONLY) --- */
INSERT INTO User_Access (user_id, password_hash, role_id, email) VALUES
(4, 'hash4', 5, 'lucas@manager.com'), (6, 'hash6', 1, 'oliver@frontdesk.com'),
(7, 'hash7', 3, 'aisha@maintenance.com'), (8, 'hash8', 2, 'noah@finance.com'),
(9, '1234', 4, '1234'), (10, '123', 5, '123'), (13, 'h13', 3, 'jack@m.com'),
(16, 'h16', 1, 'lily@f.com'), (19, 'h19', 3, 'will@m.com'),
(22, 'hash22', 1, 'elena@frontdesk.com'), (25, 'hash25', 3, 'dan@maintenance.com'),
-- New Accounts
(26, 'hash26', 3, 'gareth.m@cardiff.com'), (28, 'hash28', 3, 'victor.m@london.com'),
(30, 'hash30', 3, 'elena.m@manc.com'), (32, 'hash32', 2, 'alice.f@bristol.com'), (33, 'hash33', 1, 'bethan.f@cardiff.com'),
...
/* --- TENANTS & LEASES --- */
INSERT INTO Tenant (tenant_id, user_id, ni_number, telephone, occupation, email) VALUES
(1, 1, 'NI101A', 700111, 'Student', 'ahmed.ali@tenant.paragon.com'),
(2, 2, 'NI202B', 700222, 'Teacher', 'sophie.taylor@tenant.paragon.com'),
(3, 11, 'NI1212T', 71212, 'Tester', 'test.tenant@tenant.paragon.com'),
(4, 12, 'NI444D', 70044, 'Designer', 'emily.cook@tenant.paragon.com'),
(5, 14, 'NI555E', 70055, 'Writer', 'mark.spencer@tenant.paragon.com'),
(6, 20, 'NI666F', 70066, 'Solicitor', 'liam.davies@tenant.paragon.com'),
(7, 21, 'NI777G', 700777, 'Architect', 'james.sterling@tenant.paragon.com'),
(8, 23, 'NI888H', 700888, 'Engineer', 'marcus.brown@tenant.paragon.com'),
(9, 24, 'NI999I', 700999, 'Nurse', 'chloe.wilder@tenant.paragon.com'),
(10, 27, 'NI111X', 700112, 'Chef', 'sienna.miller@tenant.paragon.com'),
(11, 29, 'NI222Y', 700223, 'Pharmacist', 'george.higgins@tenant.paragon.com'),
(12, 31, 'NI333Z', 700334, 'Musician', 'pete.townsend@tenant.paragon.com');
...
INSERT INTO Tenant (tenant_id, user_id, ni_number, telephone, occupation, email) VALUES
(13, 56, 'AB123456C', 770001, 'Analyst', 'theo.miller@tenant.paragon.com'),
(14, 57, 'CD223344A', 770002, 'Nurse', 'uma.patel@tenant.paragon.com'),
(15, 58, 'EF334455B', 770003, 'Chef', 'vinnie.ross@tenant.paragon.com'),
(16, 59, 'GH445566C', 770004, 'Designer', 'willow.james@tenant.paragon.com'),
(17, 60, 'JK556677D', 770005, 'Engineer', 'xander.ali@tenant.paragon.com'),
(18, 61, 'LM667788A', 770006, 'Teacher', 'yasmin.cook@tenant.paragon.com'),
(19, 62, 'NP778899B', 770007, 'Consultant', 'zane.white@tenant.paragon.com'),
(20, 63, 'QR889900C', 770008, 'Developer', 'aria.young@tenant.paragon.com'),
(21, 64, 'ST990011D', 770009, 'Architect', 'blake.noor@tenant.paragon.com'),
(22, 65, 'UV101112A', 770010, 'Scientist', 'cora.flynn@tenant.paragon.com'),
(23, 66, 'WX121314B', 770011, 'Planner', 'devon.shah@tenant.paragon.com'),
(24, 67, 'YZ141516C', 770012, 'Accountant', 'elio.moore@tenant.paragon.com');
